...
namespace TaskSystem.DataAccess
{
    ...
    partial void InsertMajor_Course(Major_Course instance);
    partial void UpdateMajor_Course(Major_Course instance);
    partial void DeleteMajor_Course(Major_Course instance);
    ...
    partial void DeleteStudent(Student instance);
		...
		public System.Data.Linq.Table<Major_Course> Major_Course
		{
			get
			{
				return this.GetTable<Major_Course>();
			}
		}
    ...
    partial void OnadressChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_adress", DbType="VarChar(256)")]
    ...
    partial void OncommentChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_content", DbType="VarChar(4096)")]
    ...
    partial void OnmajorChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_descrip", DbType="VarChar(1024)")]
	...
	public partial class Course : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Major_Course> _Major_Course;
    ...
    partial void Onend_timeChanged();
		...
		public Course()
		{
			...
			this._Major_Course = default(EntityRef<Major_Course>);
			this._Teacher1 = default(EntityRef<Teacher>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_num", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string num
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Course_Major_Course", Storage="_Major_Course", ThisKey="num", OtherKey="course", IsUnique=true, IsForeignKey=false)]
		public Major_Course Major_Course
		{
			get
			{
				return this._Major_Course.Entity;
			}
			set
			{
				Major_Course previousValue = this._Major_Course.Entity;
				if (((previousValue != value) 
							|| (this._Major_Course.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Major_Course.Entity = null;
						previousValue.Course1 = null;
					}
					this._Major_Course.Entity = value;
					if ((value != null))
					{
						value.Course1 = this;
					}
					this.SendPropertyChanged("Major_Course");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Major_Course")]
	public partial class Major_Course : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OncourseChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Course_Major_Course", Storage="_Course1", ThisKey="course", OtherKey="num", IsForeignKey=true)]
		public Course Course1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Course1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Course1.Entity = null;
						previousValue.Major_Course = null;
					}
					this._Course1.Entity = value;
					if ((value != null))
					{
						value.Major_Course = this;
						this._course = value.num;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_Major_Course", Storage="_Student", ThisKey="major", OtherKey="username", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Student.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Major_Course.Remove(this);
					}
					this._Student.Entity = value;
					if ((value != null))
					{
						value.Major_Course.Add(this);
						this._major = value.username;
					}
					else
					{
	...
	public partial class Student : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Major_Course> _Major_Course;
    ...
    partial void OnmajorChanged();
		...
		public Student()
		{
			this._Accessory = new EntitySet<Accessory>(new Action<Accessory>(this.attach_Accessory), new Action<Accessory>(this.detach_Accessory));
			this._Answer = new EntitySet<Answer>(new Action<Answer>(this.attach_Answer), new Action<Answer>(this.detach_Answer));
			this._Major_Course = new EntitySet<Major_Course>(new Action<Major_Course>(this.attach_Major_Course), new Action<Major_Course>(this.detach_Major_Course));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_Major_Course", Storage="_Major_Course", ThisKey="username", OtherKey="major")]
		public EntitySet<Major_Course> Major_Course
		{
			get
			{
				return this._Major_Course;
			}
			set
			{
				this._Major_Course.Assign(value);
			}
		}
		...
		private void attach_Major_Course(Major_Course entity)
		{
			this.SendPropertyChanging();
			entity.Student = this;
		}
		
		private void detach_Major_Course(Major_Course entity)
		{
			this.SendPropertyChanging();
			entity.Student = null;
		}
