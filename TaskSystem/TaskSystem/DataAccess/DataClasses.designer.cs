...
namespace TaskSystem.DataAccess
{
    ...
    partial void OnnumberChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Course_Assignment", Storage="_Course1", ThisKey="course", OtherKey="num", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnadressChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Assignment_Accessory", Storage="_Assignment1", ThisKey="assignment", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_Accessory", Storage="_Student1", ThisKey="student", OtherKey="username", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnstateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Problem_Answer", Storage="_Problem1", ThisKey="problem", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_Answer", Storage="_Student1", ThisKey="student", OtherKey="username", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Student Student1
		{
			get
			{
    ...
    partial void Onend_timeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Teacher_Course", Storage="_Teacher1", ThisKey="teacher", OtherKey="username", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnscoreChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Assignment_Problem", Storage="_Assignment1", ThisKey="assignment", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Assignment Assignment1
		{
			get
			{
    ...
    partial void OncourseChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Course_Student_Course", Storage="_Course1", ThisKey="course", OtherKey="num", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Course Course1
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_Student_Course", Storage="_Student1", ThisKey="student", OtherKey="username", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Student Student1
		{
			get
			{
